...
namespace Onyx32::Gui
{
	class Factory : public IFactory
	{
		public:
			...
			virtual IDateTime* CreateDateTime(IWindow* parent, UINT controlId, UINT width, UINT height, UINT xPos, UINT yPos) override;
			virtual ITextInput* CreateTextInput(IWindow* parent, UINT controlId, std::wstring_view text, UINT width, UINT height, UINT xPos, UINT yPos) override;
